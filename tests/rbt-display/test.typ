...
#starling.last(rbt.display(t))

#pagebreak()

// 2. Per-call theme override: pastel palette with darker text.
#starling.last(rbt.display(t, theme: (rbt: (
  red-fill: rgb("#fca5a5"),
...
// 3. State-based theme: a `set-theme` override propagates to subsequent
