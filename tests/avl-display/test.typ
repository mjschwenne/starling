...
#starling.last(avl.display(t))

#pagebreak()

// 2. Display with balance-factor tags. Tags read 0 / +1 / -1 since
// the tree is balanced.
#starling.last(avl.display(t, factors: true))
...
// incoming edge.
#starling.last(avl.display(t, heights: true))
...
#starling.last(avl.display(t, factors: true, heights: true))
